...
class AbstractPackageSanityTestsTest {
    ...
    @Test
    void testFindClassesToTest_testClass() {
    ...
    @Test
    void testFindClassesToTest_noCorrespondingTestClass() {
    ...
    @Test
    void testFindClassesToTest_publicApiOnly() {
    ...
    @Test
    void testFindClassesToTest_ignoreUnderscores() {
    ...
    @Test
    void testFindClassesToTest_withCorrespondingTestClassButNotExplicitlyTested() {
    ...
    @Test
    void testFindClassesToTest_withCorrespondingTestClassAndExplicitlyTested() {
    ...
    @Test
    void testFindClassesToTest_withCorrespondingTestClass_noTestName() {
