...
public class NullPointerTesterTest extends TestCase {
    ...
    public static class OneArg {
        ...
        public static void staticOneArgNullableCorrectlyDoesNotThrowNPE(String s) {
            // null?  no problem
        }
        ...
        public static void staticOneArgNullableCorrectlyThrowsOtherThanNPE(String s) {
            throw new FooException(); // ok, as long as it's not NullPointerException
        }
        ...
        public static void staticOneArgNullableThrowsNPE(String s) {
            checkNotNull(s); // doesn't check if you said you'd accept null, but you don't
        }
        ...
        public void oneArgNullableCorrectlyDoesNotThrowNPE(String s) {
            // null?  no problem
        }
        ...
        public void oneArgNullableCorrectlyThrowsOtherThanNPE(String s) {
            throw new FooException(); // ok, as long as it's not NullPointerException
        }
        ...
        public void oneArgNullableThrowsNPE(String s) {
            checkNotNull(s); // doesn't check if you said you'd accept null, but you don't
        }
    }
    ...
    public static class TwoArg {
        ...
        @SuppressWarnings("GoodTime") // false positive; b/122617528
        public void normalNullable(String first, Integer second) {
            reactToNullParameters(first, second);
        }

        /** Two-arg method with the first param Nullable. */
        @SuppressWarnings("GoodTime") // false positive; b/122617528
        public void nullableNormal(String first, Integer second) {
            reactToNullParameters(first, second);
        }

        /** Two-arg method with the both params Nullable. */
        @SuppressWarnings("GoodTime") // false positive; b/122617528
        public void nullableNullable(String first, Integer second) {
            reactToNullParameters(first, second);
        }
    ...
    private static class PassObject extends SomeClassThatDoesNotUseNullable {
        ...
        public void oneNullableArg(String s) {
        }

        public void oneNullableArgThrows(String s) {
            doThrow(s);
        }
        ...
        public void twoMixedArgs(String s, Integer i) {
            checkNotNull(s);
        }

        public void twoMixedArgs(Integer i, String s) {
            checkNotNull(s);
        }

        public void twoMixedArgsThrows(String s, Integer i) {
            checkNotNull(s);
            doThrow(i);
        }

        public void twoMixedArgsThrows(Integer i, String s) {
            checkNotNull(s);
            doThrow(i);
        }

        public void twoNullableArgs(String s, @javax.annotation.Nullable Integer i) {
        }

        public void twoNullableArgsThrowsFirstArg(String s, Integer i) {
            doThrow(s);
        }

        public void twoNullableArgsThrowsSecondArg(String s, Integer i) {
            doThrow(i);
        }
        ...
        public static void staticOneNullableArg(String s) {
        }

        public static void staticOneNullableArgThrows(String s) {
            doThrow(s);
        }
    }
    ...
    private static class PassTwoNullableArgsFirstThrowsNPE extends PassObject {
        @Override
        public void twoNullableArgs(String s, Integer i) {
            checkNotNull(s); // ok to throw NPE?
        }
    }
    ...
    private static class SubclassOverridesTheWrongMethod extends BaseClassThatFailsToThrow {
        public void oneArg(CharSequence s) {
        }
    }
    ...
    private static class PrivateClassWithPrivateConstructor {
        private PrivateClassWithPrivateConstructor(Integer argument) {
        }
    }
    ...
    public static class NullBounds<T extends Object, U extends T, X> {
        boolean xWasCalled;
        ...
        @SuppressWarnings("unused") // Called by reflection
        public void t(T t) {
            fail("Method with parameter <T extends Object> should not be called");
        }

        @SuppressWarnings("unused") // Called by reflection
        public void u(U u) {
            fail(
                    "Method with parameter <U extends T> where <T extends Object> should not be"
                            + " called");
        }

        @SuppressWarnings("unused") // Called by reflection
        public <A extends Object> void a(A a) {
            fail("Method with parameter <A extends Object> should not be called");
        }

        @SuppressWarnings("unused") // Called by reflection
        public <A extends B, B extends Object> void b(A a) {
            fail(
                    "Method with parameter <A extends B> where <B extends Object> should not be"
                            + " called");
        }
    }
    ...
    public void testNullBounds() {
        ...
        // "extends Object" as a bound. This test ensures that NullPointerTester considers
