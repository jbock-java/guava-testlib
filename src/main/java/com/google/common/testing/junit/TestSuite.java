...
public class TestSuite implements Test {
    ...
    static public Test createTest(Class<?> theClass, String name) {
        ...
        try {
            ...
            return (warning("Cannot instantiate test case: " + name + " (" + TestFailure.getStacktrace(e) + ")"));
        } catch (InvocationTargetException e) {
            return (warning("Exception in constructor: " + name + " (" + TestFailure.getStacktrace(e.getTargetException()) + ")"));
        } catch (IllegalAccessException e) {
            return (warning("Cannot access test case: " + name + " (" + TestFailure.getStacktrace(e) + ")"));
        }
        return (Test) test;
    }
