...
/**
 * Factory methods for {@code ExecutorService} for testing.
 *
...
public final class TestingExecutors {
    ...
    /**
     * Returns a {@code ScheduledExecutorService} that never executes anything.
     *
     ...
     * execute/submit/schedule}, as in {@code CallerRunsPolicy}. This applies both to individually
